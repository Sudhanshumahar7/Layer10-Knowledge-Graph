    ...
    return (
        <aside className="sidebar">
            ...
            <div className="sidebar-logo">
                <span className="sidebar-badge">KG</span>
                <span className="sidebar-logo-name">Layer10</span>
            </div>
                        ...
                        {meta.entity_types.map(t => (
                            <button
                                ...
                                style={selectedTypes.includes(t)
                                    ? { borderColor: TYPE_COLORS[t] || 'var(--accent)', color: TYPE_COLORS[t] || 'var(--accent)', background: (TYPE_COLORS[t] || '#b8955a') + '22' }
                                    : {}
                                }
                            >
                                {TYPE_ICONS[t] || '❓'} {t}
